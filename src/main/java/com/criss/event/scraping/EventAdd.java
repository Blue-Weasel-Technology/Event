...
public class EventAdd {
    ...
    public static int add(String description, java.sql.Timestamp eventDateTime, String image, double latitude, String locationDescription, double longitude, String name, String style, String link) {
        var sql = "INSERT INTO events(description, event_date_time, image, latitude, location_description, longitude, name, style, link) "
                + "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)";
